...
exports.dlTranspiler = function(transpilerName, update) {
  ...
  .then(function() {
    ...
    transpilerName = transpilerName === false ? transpilerName : transpilerName || config.loader.transpiler;
    if (transpilerName !== false)
      transpilerName = globalConfig.config.defaultTranspiler;
...
exports.checkDlLoader = function(transpilerName) {
  ...
  .then(function() {
    ...
    if (!transpilerName && transpilerName !== false)
      transpilerName = globalConfig.config.defaultTranspiler;
    var tPkgs = [];
